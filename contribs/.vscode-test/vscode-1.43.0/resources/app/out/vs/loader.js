...
!(function(e) {
      ...
      return (
            ...
            'function' != typeof n.onError &&
              (n.onError = function(e) {
                return 'loading' === e.phase
                  ...
                  : 'factory' === e.phase
                  ? (console.error('The factory method of "' + e.moduleId + '" has thrown an exception'), void console.error(e))
                  : void 0
              }),
        ...
        (n.mergeConfigurationOptions = function(t, r) {
          ...
          return (
            ...
            n.validateConfigurationOptions(o)
          )
        }),
        n
      )
      ...
      function t(e, t) {
        if (
          ...
          if (this.options.nodeMain && this._env.isNode) {
            ;(r = this.options.nodeMain), (o = Math.max(r.lastIndexOf('/'), r.lastIndexOf('\\')))
            this.options.baseUrl = r.substring(0, o + 1)
          }
        }
      }
      return (
        ...
        (t.prototype._createSortedPathsRules = function() {
          ...
          ;(this.sortedPathsRules = []),
            e.Utilities.forEachProperty(this.options.paths, function(e, n) {
              Array.isArray(n) ? t.sortedPathsRules.push({ from: e, to: n }) : t.sortedPathsRules.push({ from: e, to: [n] })
            }),
        ...
        (t.prototype.moduleIdToPaths = function(t) {
          ...
          if (e.Utilities.endsWith(r, '.js') || e.Utilities.isAbsolutePath(r))
            ...
            for (var o = 0, i = (n = this._applyPaths(r)).length; o < i; o++)
              (this.isBuild() && 'empty:' === n[o]) ||
                (e.Utilities.isAbsolutePath(n[o]) || (n[o] = this.options.baseUrl + n[o]),
                e.Utilities.endsWith(n[o], '.js') || e.Utilities.containsQueryString(n[o]) || (n[o] = n[o] + '.js'))
    ...
    var t = (function() {
        ...
        return (
          (e.prototype.load = function(e, t, i, s) {
            var a = this
            this._scriptLoader || (this._scriptLoader = this._env.isWebWorker ? new r() : this._env.isNode ? new o(this._env) : new n())
        ...
        return (
            ...
            if (n && !this._didPatchNodeRequire) {
              ...
              o.prototype._compile = function(e, i) {
                var s,
                  a = o.wrap(e.replace(/^#!.*/, '')),
                  u = t.getRecorder(),
                  d = r._getCachedDataPath(n, i),
                  l = { filename: i }
                try {
                  var c = r._fs.readFileSync(d)
                  ;(s = c.slice(0, 16)), (l.cachedData = c.slice(16)), u.record(60, d)
                } catch (e) {
                  u.record(61, d)
                }
                var h = new r._vm.Script(a, l),
                ...
                return r._handleCachedData(h, a, d, !l.cachedData, t), r._verifyCachedData(h, a, d, s, t), v
              }
            }
          }),
          (t.prototype.load = function(n, r, o, i) {
            var s = this,
              ...
              u = a.nodeRequire || e.global.nodeRequire,
              d =
                a.nodeInstrumenter ||
                function(e) {
                  return e
            ...
            if (/^node\|/.test(r)) {
              ...
              var f = this._path.normalize(r),
                ...
                g = _ ? this._getCachedDataPath(a.nodeCachedData, r) : void 0
              this._readSourceAndCachedData(f, g, l, function(e, r, a, u) {
                if (e) i(e)
                else {
                  var l
                  ;(l = r.charCodeAt(0) === t._BOM ? t._PREFIX + r.substring(1) + t._SUFFIX : t._PREFIX + r + t._SUFFIX), (l = d(l, f))
                  var c = { filename: p, cachedData: a },
                    h = s._createAndEvalScript(n, l, c, o, i)
                  s._handleCachedData(h, l, g, _ && !a, n), s._verifyCachedData(h, l, g, u, n)
                }
              })
            }
          }),
          (t.prototype._createAndEvalScript = function(t, n, r, o, i) {
            var s = t.getRecorder()
            s.record(31, r.filename)
            var a = new this._vm.Script(n, r),
              u = a.runInThisContext(r),
              d = t.getGlobalAMDDefineFunc(),
              l = !1,
              c = function() {
                return (l = !0), d.apply(null, arguments)
              }
            return (
              (c.amd = d.amd),
              u.call(e.global, t.getGlobalAMDRequireFunc(), c, r.filename, this._path.dirname(r.filename)),
              s.record(32, r.filename),
              l ? o() : i(new Error("Didn't receive define call in " + r.filename + '!')),
              a
            )
          }),
          ...
          (t.prototype._handleCachedData = function(e, t, n, r, o) {
            var i = this
            e.cachedDataRejected
              ? this._fs.unlink(n, function(r) {
                  o.getRecorder().record(62, n), i._createAndWriteCachedData(e, t, n, o), r && o.getConfig().onError(r)
                })
              : r && this._createAndWriteCachedData(e, t, n, o)
          }),
          (t.prototype._createAndWriteCachedData = function(e, t, n, r) {
            var o = this,
              i = Math.ceil(r.getConfig().getOptionsLiteral().nodeCachedData.writeDelay * (1 + Math.random())),
              s = -1,
              a = 0,
              u = void 0,
              d = function() {
                setTimeout(function() {
                  ...
                  0 === i.length ||
                    ...
                    a >= 5 ||
                    ((s = i.length),
                    o._fs.writeFile(n, Buffer.concat([u, i]), function(e) {
                      e && r.getConfig().onError(e), r.getRecorder().record(63, n), d()
                    }))
                }, i * Math.pow(4, a++))
              }
            d()
          ...
          (t.prototype._readSourceAndCachedData = function(e, t, n, r) {
            if (t) {
              var o = void 0,
                ...
                a = 2,
                u = function(e) {
                  e ? r(e) : 0 == --a && r(void 0, o, i, s)
                }
              this._fs.readFile(e, { encoding: 'utf8' }, function(e, t) {
                ;(o = t), u(e)
              }),
                this._fs.readFile(t, function(e, r) {
                  !e && r && r.length > 0 ? ((s = r.slice(0, 16)), (i = r.slice(16)), n.record(60, t)) : n.record(61, t), u()
                })
            } else this._fs.readFile(e, { encoding: 'utf8' }, r)
          }),
          (t.prototype._verifyCachedData = function(e, t, n, r, o) {
            var i = this
            r &&
              (e.cachedDataRejected ||
                setTimeout(function() {
                  ...
                  r.equals(e) ||
                    (o
                      .getConfig()
                      .onError(new Error("FAILED TO VERIFY CACHED DATA, deleting stale '" + n + "' now, but a RESTART IS REQUIRED")),
      ...
      return (
        ...
        (t._invokeFactory = function(t, n, r, o) {
          return t.isBuild() && !e.Utilities.isAnonymousModule(n)
            ...
            : { returnedValue: r.apply(e.global, o), producedError: null }
        }),
    ...
    var r = (function() {
        ...
        return (
          ...
          (e.prototype.getModuleId = function(e) {
            ...
            return (
              void 0 === t && ((t = this._nextId++), this._strModuleIdToIntModuleId.set(e, t), (this._intModuleIdToStrModuleId[t] = e)), t
            )
          }),
    ...
    var s = (function() {
      ...
      return (
        ...
        (s._findRelevantLocationInStack = function(e, t) {
          for (
            ...
            if (s) {
              ...
              if ((a = n((a = a.substr(l)))) === r) {
                var c = { line: parseInt(u, 10), col: parseInt(d, 10) }
        ...
        (s.prototype.defineModule = function(e, r, o, i, s, a) {
          ...
          if (this._modules2[d]) this._config.isDuplicateMessageIgnoredFor(e) || console.warn("Duplicate definition of module '" + e + "'")
          else {
            var l = new n(d, e, this._normalizeDependencies(r, a), o, i, a)
            ;(this._modules2[d] = l),
              this._config.isBuild() &&
                ((this._buildInfoDefineStack[d] = s),
                (this._buildInfoDependencies[d] = (l.dependencies || []).map(function(e) {
        ...
        (s.prototype._normalizeDependency = function(e, t) {
          ...
          if (n >= 0) {
            var r = t.resolveModule(e.substr(0, n)),
              ...
              u = this._moduleIdProvider.getModuleId(r)
            return new i(a, u, s)
          }
        ...
        (s.prototype.synchronousRequire = function(e, n) {
          ...
          if (!o)
            throw new Error(
              "Check dependency list! Synchronous require cannot resolve module '" + e + "'. This is the first mention of this module!"
            )
          if (!o.isComplete())
            throw new Error(
        ...
        (s.prototype._onLoadError = function(e, t) {
          ...
          var a = !1,
            u = []
          for (u.push(e), o[e] = !0; u.length > 0; ) {
            var d = u.shift(),
              l = this._modules2[d]
            l && (a = l.onDependencyError(r) || a)
            var c = this._inverseDependencies2[d]
            if (c)
          ...
          for (s.push(n), r[e] = !0; s.length > 0; ) {
            ...
            if (a)
              for (o = 0, i = a.length; o < i; o++) {
                var u = a[o]
                if (u.id === t) return !0
                var d = this._modules2[u.id]
                d && !r[u.id] && ((r[u.id] = !0), s.push(d))
              }
          }
          return !1
        }),
        ...
        (s.prototype._loadModule = function(e) {
          ...
          if (!this._modules2[e] && !this._knownModules2[e]) {
            ...
            var o = -1,
              i = function(n) {
                if (++o >= r.length) t._onLoadError(e, n)
                else {
                  var s = r[o],
                    a = t.getRecorder()
              ...
              if (a !== o.EXPORTS)
                if (a !== o.MODULE)
                  if (a !== o.REQUIRE) {
                    ...
                    if (u && u.isComplete()) {
                      if (u.error) return void e.onDependencyError(u.error)
                      ...
                      var d = this._findCyclePath(a.id, e.id, 0) || []
                      d.reverse(),
                        d.push(a.id),
                        console.warn(
                          d
  ...
  (function(e) {
    ...
    function s() {
      ...
      t.isNode && !t.isElectronRenderer
        ...
        : (t.isElectronRenderer || (e.global.define = r), (e.global.require = i))
    }
    ;(i.config = o),
      ...
      ('function' == typeof e.global.define && e.global.define.amd) ||
        ((n = new e.ModuleManager(t, e.createScriptLoader(t), r, i, e.Utilities.getHighPerformanceTimestamp())),
  ...
  (function(e) {
    var t = (function() {
      ...
      return (
        Object.defineProperty(e.prototype, 'isPseudo', {
          get: function() {
          ...
          0 === t.length
            ...
            : e.replace(/\{(\d+)\}/g, function(e, n) {
                var r = n[0],
                  o = t[r],
                  i = e
                return 'string' == typeof o ? (i = o) : ('number' != typeof o && 'boolean' != typeof o && null != o) || (i = String(o)), i
              })),
        n.isPseudo && (r = '［' + r.replace(/[aouei]/g, '$&$&') + '］'),
        r
      )
    }
    function r(e, t, r) {
    ...
    var i = (function() {
      function e(e) {
        var t = this
        ;(this._env = e),
          (this.localize = function(e, n) {
            for (var o = [], i = 2; i < arguments.length; i++) o[i - 2] = arguments[i]
            return r.apply(void 0, [t._env, e, n].concat(o))
          })
      }
      return (
        ...
        (e.prototype.load = function(t, n, r, i) {
          ...
          if (((i = i || {}), t && 0 !== t.length)) {
            var a = i['vs/nls'] || {},
              u = a.availableLanguages
                ? (function(e, t) {
                    var n = e[t]
                    return n || (n = e['*']) || null
                  })(a.availableLanguages, t)
                : null,
              d = '.nls'
            null !== u && u !== e.DEFAULT_TAG && (d = d + '.' + u)
            var l = function(e) {
              Array.isArray(e) ? (e.localize = o(e, s._env)) : (e.localize = o(e[t], s._env)), r(e)
            }
            'function' == typeof a.loadBundle
              ? a.loadBundle(t, u, function(e, r) {
                  e ? n([t + '.nls'], l) : l(r)
                })
              : n([t + d], l)
          } else r({ localize: this.localize })
        }),
        (e.DEFAULT_TAG = 'i-default'),
        e
      )
    })()
    ;(e.NLSPlugin = i), define('vs/nls', new i(new t()))
  })(NLSLoaderPlugin || (NLSLoaderPlugin = {}))
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/78a4c91400152c0f27ba4d363eb56d2835f9903a/core/vs/loader.js.map
